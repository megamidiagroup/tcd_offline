...
(function($) {
  ...
  $.modal2.prototype = {
    ...
    open: function() {
      ...
      if (this.options.escapeClose) {
        $(document).on('keydown.modal', function(event) {
          if (event.which == 27) $.modal2.close();
        });
      }
      if (this.options.clickClose) this.blocker.click($.modal2.close);
    },
    ...
    show: function() {
      ...
      this.center();
      this.$elm.show().trigger($.modal2.OPEN, [this._ctx()]);
    },
  ...
  $.modal2.prototype.resize = $.modal2.prototype.center;
  ...
  $.fn.modal2 = function(options){
    if (this.length === 1) {
      current = new $.modal2(this, options);
    }
    return this;
  };
