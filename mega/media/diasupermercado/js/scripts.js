...
$(function() {
	...
	function ajustaRodape()
	{
		...
		if(espaco > 0)
		{
			var newHeight = $('#content .container').height() + espaco;
	...
	$("#content .container img").one('load', function() {
         count_load++;
         $(this).fadeIn(1000);
...
    }) 
	...
	var category = $('#content .category li');
	if(category.length)
	{
		for(i=0; i<category.length; i++)
		{
			if(i%3 == 0)$(category[i]).addClass("clear");
		}
	}
