...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Banner.category'
        db.delete_column('mega_banner', 'category_id')

        # Adding M2M table for field category on 'Banner'
        db.create_table('mega_banner_category', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('banner', models.ForeignKey(orm['mega.banner'], null=False)),
            ('category', models.ForeignKey(orm['mega.category'], null=False))
        ))
        db.create_unique('mega_banner_category', ['banner_id', 'category_id'])


    def backwards(self, orm):
        # Adding field 'Banner.category'
        db.add_column('mega_banner', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['mega.Category'], blank=True),
                      keep_default=False)

        # Removing M2M table for field category on 'Banner'
        db.delete_table('mega_banner_category')
