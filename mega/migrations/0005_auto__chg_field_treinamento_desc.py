...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Treinamento.desc'
        db.alter_column('mega_treinamento', 'desc', self.gf('ckeditor.fields.RichTextField')())

    def backwards(self, orm):

        # Changing field 'Treinamento.desc'
        db.alter_column('mega_treinamento', 'desc', self.gf('django.db.models.fields.TextField')())
