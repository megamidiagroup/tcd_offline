...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Rede.is_faq'
        db.add_column('mega_rede', 'is_faq', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Rede.is_faq'
        db.delete_column('mega_rede', 'is_faq')
