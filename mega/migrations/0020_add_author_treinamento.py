...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Treinamento.author'
        db.add_column('mega_treinamento', 'author', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Treinamento.author'
        db.delete_column('mega_treinamento', 'author')
