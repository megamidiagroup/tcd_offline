...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Template.title_d'
        db.add_column('mega_template', 'title_d', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))

        # Adding field 'Template.cor38'
        db.add_column('mega_template', 'cor38', self.gf('colors.fields.ColorField')(default='ffffff', max_length=7, blank=True))

        # Adding field 'Template.cor37'
        db.add_column('mega_template', 'cor37', self.gf('colors.fields.ColorField')(default='ffffff', max_length=7, blank=True))

        # Adding field 'Template.title_ds'
        db.add_column('mega_template', 'title_ds', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))

        # Adding field 'Template.title_pd'
        db.add_column('mega_template', 'title_pd', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Template.title_d'
        db.delete_column('mega_template', 'title_d')

        # Deleting field 'Template.cor38'
        db.delete_column('mega_template', 'cor38')

        # Deleting field 'Template.cor37'
        db.delete_column('mega_template', 'cor37')

        # Deleting field 'Template.title_ds'
        db.delete_column('mega_template', 'title_ds')

        # Deleting field 'Template.title_pd'
        db.delete_column('mega_template', 'title_pd')
