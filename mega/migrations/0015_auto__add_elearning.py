...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Elearning'
        db.create_table('mega_elearning', (
            ...
            ('dir', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('mega', ['Elearning'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'Elearning'
        db.delete_table('mega_elearning')
