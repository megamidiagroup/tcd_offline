...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InfoUser.cnpj'
        db.add_column('mega_infouser', 'cnpj', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True))

        # Changing field 'InfoUser.cpf'
        db.alter_column('mega_infouser', 'cpf', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'InfoUser.cnpj'
        db.delete_column('mega_infouser', 'cnpj')

        # Changing field 'InfoUser.cpf'
        db.alter_column('mega_infouser', 'cpf', self.gf('django.db.models.fields.CharField')(max_length=15))
