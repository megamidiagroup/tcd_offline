...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Category.home'
        db.add_column('mega_category', 'home', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True))

        # Adding field 'Parceiro.link'
        db.add_column('mega_parceiro', 'link', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Category.home'
        db.delete_column('mega_category', 'home')

        # Deleting field 'Parceiro.link'
        db.delete_column('mega_parceiro', 'link')
