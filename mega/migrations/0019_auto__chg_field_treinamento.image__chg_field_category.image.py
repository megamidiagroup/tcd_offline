...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Treinamento.image'
        db.alter_column('mega_treinamento', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=255, blank=True))

        # Changing field 'Category.image'
        db.alter_column('mega_category', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=255, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Treinamento.image'
        db.alter_column('mega_treinamento', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=255))

        # Changing field 'Category.image'
        db.alter_column('mega_category', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=255))
