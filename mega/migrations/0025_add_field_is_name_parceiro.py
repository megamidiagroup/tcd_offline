...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Parceiro.is_name'
        db.add_column('mega_parceiro', 'is_name', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Parceiro.is_name'
        db.delete_column('mega_parceiro', 'is_name')
