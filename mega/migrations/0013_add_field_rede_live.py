...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InfoUser.visible'
        db.alter_column('mega_infouser', 'visible', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'InfoUser.access'
        db.alter_column('mega_infouser', 'access', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'InfoUser.receber'
        db.alter_column('mega_infouser', 'receber', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'InfoUser.envia'
        db.alter_column('mega_infouser', 'envia', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'RelatorioTentativa.aprovado'
        db.alter_column('mega_relatoriotentativa', 'aprovado', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Faq.access'
        db.alter_column('mega_faq', 'access', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Faq.visible'
        db.alter_column('mega_faq', 'visible', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Banner.visible'
        db.alter_column('mega_banner', 'visible', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Banner.blank'
        db.alter_column('mega_banner', 'blank', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Banner.home'
        db.alter_column('mega_banner', 'home', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Banner.legend'
        db.alter_column('mega_banner', 'legend', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Adding field 'Live.rede'
        db.add_column('mega_live', 'rede', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mega.Rede']))

        # Changing field 'Template.visible'
        db.alter_column('mega_template', 'visible', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Menu.visible'
        db.alter_column('mega_menu', 'visible', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Filial.visible'
        db.alter_column('mega_filial', 'visible', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Certificado.visible'
        db.alter_column('mega_certificado', 'visible', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Response.correta'
        db.alter_column('mega_response', 'correta', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Question.visible'
        db.alter_column('mega_question', 'visible', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Rede.visible'
        db.alter_column('mega_rede', 'visible', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Parceiro.visible'
        db.alter_column('mega_parceiro', 'visible', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Parceiro.home'
        db.alter_column('mega_parceiro', 'home', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Treinamento.code'
        db.alter_column('mega_treinamento', 'code', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True))

        # Changing field 'Treinamento.visible'
        db.alter_column('mega_treinamento', 'visible', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Treinamento.destaq'
        db.alter_column('mega_treinamento', 'destaq', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'RelatorioAcoes.play'
        db.alter_column('mega_relatorioacoes', 'play', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'RelatorioAcoes.complete'
        db.alter_column('mega_relatorioacoes', 'complete', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Category.access'
        db.alter_column('mega_category', 'access', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Category.visible'
        db.alter_column('mega_category', 'visible', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Category.is_name'
        db.alter_column('mega_category', 'is_name', self.gf('django.db.models.fields.BooleanField')(blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'InfoUser.visible'
        db.alter_column('mega_infouser', 'visible', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'InfoUser.access'
        db.alter_column('mega_infouser', 'access', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'InfoUser.receber'
        db.alter_column('mega_infouser', 'receber', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'InfoUser.envia'
        db.alter_column('mega_infouser', 'envia', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'RelatorioTentativa.aprovado'
        db.alter_column('mega_relatoriotentativa', 'aprovado', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Faq.access'
        db.alter_column('mega_faq', 'access', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Faq.visible'
        db.alter_column('mega_faq', 'visible', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Banner.visible'
        db.alter_column('mega_banner', 'visible', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Banner.blank'
        db.alter_column('mega_banner', 'blank', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Banner.home'
        db.alter_column('mega_banner', 'home', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Banner.legend'
        db.alter_column('mega_banner', 'legend', self.gf('django.db.models.fields.BooleanField')())

        # Deleting field 'Live.rede'
        db.delete_column('mega_live', 'rede_id')

        # Changing field 'Template.visible'
        db.alter_column('mega_template', 'visible', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Menu.visible'
        db.alter_column('mega_menu', 'visible', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Filial.visible'
        db.alter_column('mega_filial', 'visible', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Certificado.visible'
        db.alter_column('mega_certificado', 'visible', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Response.correta'
        db.alter_column('mega_response', 'correta', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Question.visible'
        db.alter_column('mega_question', 'visible', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Rede.visible'
        db.alter_column('mega_rede', 'visible', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Parceiro.visible'
        db.alter_column('mega_parceiro', 'visible', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Parceiro.home'
        db.alter_column('mega_parceiro', 'home', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Treinamento.code'
        db.alter_column('mega_treinamento', 'code', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Treinamento.visible'
        db.alter_column('mega_treinamento', 'visible', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Treinamento.destaq'
        db.alter_column('mega_treinamento', 'destaq', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'RelatorioAcoes.play'
        db.alter_column('mega_relatorioacoes', 'play', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'RelatorioAcoes.complete'
        db.alter_column('mega_relatorioacoes', 'complete', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Category.access'
        db.alter_column('mega_category', 'access', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Category.visible'
        db.alter_column('mega_category', 'visible', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Category.is_name'
        db.alter_column('mega_category', 'is_name', self.gf('django.db.models.fields.BooleanField')())
