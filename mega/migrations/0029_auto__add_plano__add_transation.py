...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('mega', ['Plano'])

        # Adding model 'Transation'
        db.create_table('mega_transation', (
            ('code', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('visible', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('rede', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['mega.Rede'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('plano', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['mega.Plano'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('mega', ['Transation'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'Plano'
        db.delete_table('mega_plano')

        # Deleting model 'Transation'
        db.delete_table('mega_transation')
