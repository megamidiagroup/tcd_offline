...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Parceiro.category'
        db.delete_column('mega_parceiro', 'category_id')

        # Adding M2M table for field category on 'Parceiro'
        db.create_table('mega_parceiro_category', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('parceiro', models.ForeignKey(orm['mega.parceiro'], null=False)),
            ('category', models.ForeignKey(orm['mega.category'], null=False))
        ))
        db.create_unique('mega_parceiro_category', ['parceiro_id', 'category_id'])


    def backwards(self, orm):
        # Adding field 'Parceiro.category'
        db.add_column('mega_parceiro', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['mega.Category'], blank=True),
                      keep_default=False)

        # Removing M2M table for field category on 'Parceiro'
        db.delete_table('mega_parceiro_category')
    ...
    models = {
        ...
        'mega.parceiro': {
            ...
            'category': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['mega.Category']"}),
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '255'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
