...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Template.font_gle'
        db.add_column('mega_template', 'font_gle', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Template.font_gle'
        db.delete_column('mega_template', 'font_gle')
