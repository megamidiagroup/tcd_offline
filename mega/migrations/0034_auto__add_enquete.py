...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mega_enquete', (
            ('opcao5', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('n_opcao6', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('opcao2', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('opcao3', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('opcao6', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ...
            ('n_opcao5', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('n_opcao4', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('opcao4', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('n_opcao2', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('n_opcao1', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('n_opcao3', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('opcao1', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('mega', ['Enquete'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'Enquete'
        db.delete_table('mega_enquete')
