...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Elearning.not_video'
        db.add_column('mega_elearning', 'not_video', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Elearning.not_video'
        db.delete_column('mega_elearning', 'not_video')
