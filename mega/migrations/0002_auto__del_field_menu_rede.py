...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Menu.rede'
        db.delete_column('mega_menu', 'rede_id')

        # Adding M2M table for field rede on 'Menu'
        db.create_table('mega_menu_rede', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('menu', models.ForeignKey(orm['mega.menu'], null=False)),
            ('rede', models.ForeignKey(orm['mega.rede'], null=False))
        ))
        db.create_unique('mega_menu_rede', ['menu_id', 'rede_id'])


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Menu.rede'
        raise RuntimeError("Cannot reverse this migration. 'Menu.rede' and its values cannot be restored.")
        # Removing M2M table for field rede on 'Menu'
        db.delete_table('mega_menu_rede')
    ...
    models = {
        ...
        'mega.menu': {
            ...
            'order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'rede': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'+'", 'symmetrical': 'False', 'to': "orm['mega.Rede']"}),
