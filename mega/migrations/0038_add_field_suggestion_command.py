...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Suggestion.command'
        db.add_column('mega_suggestion', 'command', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Suggestion.command'
        db.delete_column('mega_suggestion', 'command')
