...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mega_freeresponse', (
            ('aprovado', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mega.Question'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('rede', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mega.Rede'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('porcent', self.gf('django.db.models.fields.IntegerField')(default=100)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('mega', ['FreeResponse'])

        # Adding model 'Quiz'
        db.create_table('mega_quiz', (
            ('treinamento', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mega.Treinamento'])),
            ('rede', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mega.Rede'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('porcent', self.gf('django.db.models.fields.IntegerField')(default=100)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email_respon', self.gf('django.db.models.fields.EmailField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('mega', ['Quiz'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'FreeResponse'
        db.delete_table('mega_freeresponse')

        # Deleting model 'Quiz'
        db.delete_table('mega_quiz')
