...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Plano.q_badges'
        db.add_column('mega_plano', 'q_badges', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Adding field 'Plano.tutor'
        db.add_column('mega_plano', 'tutor', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True))

        # Adding field 'Plano.quiz'
        db.add_column('mega_plano', 'quiz', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True))

        # Adding field 'Plano.q_videos'
        db.add_column('mega_plano', 'q_videos', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Adding M2M table for field badges on 'Transation'
        db.create_table('mega_transation_badges', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('transation', models.ForeignKey(orm['mega.transation'], null=False)),
            ('certificado', models.ForeignKey(orm['mega.certificado'], null=False))
        ))

        # Adding M2M table for field videos on 'Transation'
        db.create_table('mega_transation_videos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('transation', models.ForeignKey(orm['mega.transation'], null=False)),
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Plano.q_badges'
        db.delete_column('mega_plano', 'q_badges')

        # Deleting field 'Plano.tutor'
        db.delete_column('mega_plano', 'tutor')

        # Deleting field 'Plano.quiz'
        db.delete_column('mega_plano', 'quiz')

        # Deleting field 'Plano.q_videos'
        db.delete_column('mega_plano', 'q_videos')

        # Removing M2M table for field badges on 'Transation'
        db.delete_table('mega_transation_badges')

        # Removing M2M table for field videos on 'Transation'
        db.delete_table('mega_transation_videos')
