...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Faq.menu_all'
        db.add_column('mega_faq', 'menu_all', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True))

        # Adding M2M table for field treinamento on 'Faq'
        db.create_table('mega_faq_treinamento', (
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Faq.menu_all'
        db.delete_column('mega_faq', 'menu_all')

        # Removing M2M table for field treinamento on 'Faq'
        db.delete_table('mega_faq_treinamento')
    ...
    models = {
        ...
        'mega.faq': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'menu_all': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'pergunta': ('django.db.models.fields.TextField', [], {}),
            'rede': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['mega.Rede']"}),
            'resposta': ('django.db.models.fields.TextField', [], {}),
            'treinamento': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['mega.Treinamento']", 'null': 'True', 'blank': 'True'}),
            'visible': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'})
        },
        'mega.filial': {
