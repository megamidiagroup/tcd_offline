...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Template.font1'
        db.add_column('mega_template', 'font1',
                      self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Template.font2'
        db.add_column('mega_template', 'font2',
                      self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Template.font3'
        db.add_column('mega_template', 'font3',
                      self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Template.font4'
        db.add_column('mega_template', 'font4',
                      self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Template.font1'
        db.delete_column('mega_template', 'font1')

        # Deleting field 'Template.font2'
        db.delete_column('mega_template', 'font2')

        # Deleting field 'Template.font3'
        db.delete_column('mega_template', 'font3')

        # Deleting field 'Template.font4'
        db.delete_column('mega_template', 'font4')
