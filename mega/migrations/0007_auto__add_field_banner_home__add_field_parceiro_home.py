...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Banner.home'
        db.add_column('mega_banner', 'home',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Parceiro.home'
        db.add_column('mega_parceiro', 'home',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Banner.home'
        db.delete_column('mega_banner', 'home')

        # Deleting field 'Parceiro.home'
        db.delete_column('mega_parceiro', 'home')
