...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Rede.is_login'
        db.add_column('mega_rede', 'is_login', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Rede.is_login'
        db.delete_column('mega_rede', 'is_login')
