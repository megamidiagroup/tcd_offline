...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('mega_question', 'text', self.gf('ckeditor.fields.RichTextField')())

        # Adding M2M table for field required on 'Treinamento'
        db.create_table('mega_treinamento_required', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_treinamento', models.ForeignKey(orm['mega.treinamento'], null=False)),
            ('to_treinamento', models.ForeignKey(orm['mega.treinamento'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Question.text'
        db.alter_column('mega_question', 'text', self.gf('django.db.models.fields.TextField')())

        # Removing M2M table for field required on 'Treinamento'
        db.delete_table('mega_treinamento_required')
