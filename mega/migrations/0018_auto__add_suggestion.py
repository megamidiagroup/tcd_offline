...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mega_suggestion', (
            ...
            ('enviado', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
        ...
        db.send_create_signal('mega', ['Suggestion'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'Suggestion'
        db.delete_table('mega_suggestion')
