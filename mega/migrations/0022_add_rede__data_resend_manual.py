...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Rede.date_send'
        db.add_column('mega_rede', 'date_send', self.gf('django.db.models.fields.DateField')(null=True, blank=True))

        # Adding field 'Rede.email'
        db.add_column('mega_rede', 'email', self.gf('django.db.models.fields.EmailField')(max_length=255, null=True, blank=True))

        # Adding field 'Rede.resend'
        db.add_column('mega_rede', 'resend', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Rede.date_send'
        db.delete_column('mega_rede', 'date_send')

        # Deleting field 'Rede.email'
        db.delete_column('mega_rede', 'email')

        # Deleting field 'Rede.resend'
        db.delete_column('mega_rede', 'resend')
