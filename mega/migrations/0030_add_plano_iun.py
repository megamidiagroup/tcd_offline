...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Treinamento.plano'
        db.add_column('mega_treinamento', 'plano', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mega.Plano'], null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Treinamento.plano'
        db.delete_column('mega_treinamento', 'plano_id')
