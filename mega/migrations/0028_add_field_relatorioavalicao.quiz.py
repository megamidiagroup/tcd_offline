...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RelatorioAvalicao.quiz'
        db.add_column('mega_relatorioavalicao', 'quiz', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['mega.Quiz']))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'RelatorioAvalicao.quiz'
        db.delete_column('mega_relatorioavalicao', 'quiz_id')
    ...
    models = {
        ...
        'mega.relatorioavalicao': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pontos': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'quiz': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mega.Quiz']"}),
            'rede': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mega.Rede']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
