...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Template.cor40'
        db.add_column('mega_template', 'cor40', self.gf('colors.fields.ColorField')(max_length=7, null=True, blank=True))

        # Adding field 'Template.larg11'
        db.add_column('mega_template', 'larg11', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True))

        # Adding field 'Template.cor39'
        db.add_column('mega_template', 'cor39', self.gf('colors.fields.ColorField')(max_length=7, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Template.cor40'
        db.delete_column('mega_template', 'cor40')

        # Deleting field 'Template.larg11'
        db.delete_column('mega_template', 'larg11')

        # Deleting field 'Template.cor39'
        db.delete_column('mega_template', 'cor39')
    ...
    models = {
        ...
        'mega.enquete': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'n_opcao1': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'n_opcao2': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'n_opcao3': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'n_opcao4': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'n_opcao5': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'n_opcao6': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'opcao1': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'opcao2': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'opcao3': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'opcao4': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'opcao5': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'opcao6': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'rede': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mega.Rede']"}),
        ...
        'mega.plano': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'q_badges': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'q_videos': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'quiz': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'rede': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['mega.Rede']"}),
            'tutor': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
        ...
        'mega.template': {
            ...
            'cor39': ('colors.fields.ColorField', [], {'max_length': '7', 'null': 'True', 'blank': 'True'}),
            'cor4': ('colors.fields.ColorField', [], {'max_length': '7', 'null': 'True', 'blank': 'True'}),
            'cor40': ('colors.fields.ColorField', [], {'max_length': '7', 'null': 'True', 'blank': 'True'}),
            ...
            'larg11': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
        ...
        'mega.transation': {
            ...
            'badges': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['mega.Certificado']", 'null': 'True', 'blank': 'True'}),
            ...
            'rede': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['mega.Rede']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'videos': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['mega.Treinamento']", 'null': 'True', 'blank': 'True'}),
            'visible': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'})
        },
        'mega.treinamento': {
