...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'WebChatLido'
        db.delete_table('mega_webchatlido')

        # Adding M2M table for field user_lido on 'WebChat'
        db.create_table('mega_webchat_user_lido', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('webchat', models.ForeignKey(orm['mega.webchat'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('mega_webchat_user_lido', ['webchat_id', 'user_id'])


    def backwards(self, orm):
        # Adding model 'WebChatLido'
        db.create_table('mega_webchatlido', (
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('webchat', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mega.WebChat'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('mega', ['WebChatLido'])

        # Removing M2M table for field user_lido on 'WebChat'
        db.delete_table('mega_webchat_user_lido')
