...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RelatorioGrafico'
        db.create_table('relatorio_relatoriografico', (
        ...
        db.send_create_signal('relatorio', ['RelatorioGrafico'])


    def backwards(self, orm):
        # Deleting model 'RelatorioGrafico'
        db.delete_table('relatorio_relatoriografico')
    ...
    models = {
        ...
        'relatorio.relatoriografico': {
            'Meta': {'ordering': "['-date']", 'object_name': 'RelatorioGrafico'},
            'acesso': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
