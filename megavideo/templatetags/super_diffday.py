...
def diffDays(obj_datetime):
    ...
    if int(value.days) > 1:
        return "Há " + str(value.days) + " dias" 
    elif int(value.days) == 1:
        return "Há " + str(value.days) + " dia"
        ...
        if horas > 1:
              return "Há " + str(horas) + " horas"
        elif horas == 1:
              return "Há " + str(horas) + " hora"
        elif horas == 0:
              return "Há " + str( minutos ) + ":" + str(org_seg) + " min."
        
    return "Não é possível exibir!"  
        
        
register.filter('super_diffday', diffDays)