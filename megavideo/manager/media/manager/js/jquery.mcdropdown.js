 ...
 */
    ...
    var defaults = {
        ...
        , className: 'itensCategory'   // name for hiden div 
    };
    ...
    $.mcDropDownMenu = function(el, list, options){
        ...
        $divInput = $('<div class="mcdropdown"><a href="#" tabindex="-1"></a><input class="'+ settings.className +'" type="hidden" name="' + (el.name || el.id) + '" id="' + (el.id || el.name) + '" /></div>')
